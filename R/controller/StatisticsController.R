...
if (isValidJSON(inputDataFromLocal, TRUE)) {
  ...
  switch (as.character(inputData$action),
          "10000" = {
          "
            Execute the project's stats
          "    
          mydb <- openDB("dawbio1703", "z54Qf2$v", "dawbio1703", "127.0.0.1")
          setwd("../../statisticsFiles/graphs/project")
          ...
          "10010" = {
            "
            Execute the subject's stats
            "  
            mydb <- openDB("dawbio1703", "z54Qf2$v", "dawbio1703", "localhost")
            setwd("../../statisticsFiles/graphs/subject/")
          ...
          "10020" = {
            "
            Execute the session's stats
            " 
            mydb <- openDB("dawbio1703", "z54Qf2$v", "dawbio1703", "localhost")
            setwd("../../statisticsFiles/graphs/session/")
            ...
            plot(dispense$height, dispense$dose,
                 ...
                 ylab = "Dose")
            if(nrow(dispense)>2){
              abline(lm(dispense$dose ~ dispense$height))
            }
            dev.off()  
          ...
          "10030" = {
            "
            Execute the phase's stats
            " 
            mydb <- openDB("dawbio1703", "z54Qf2$v", "dawbio1703", "localhost")
            setwd("../../statisticsFiles/graphs/phase/")
